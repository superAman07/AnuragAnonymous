        ...
        <div className="text-center space-y-12 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {reels.map((reel, index) => {
              ...
              const isActive = activeReel === index

              return (
                <div
                  key={index}
                  className={`relative group p-8 bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-sm border rounded-2xl transition-all duration-700 transform ${
                    isActive
                      ? "border-amber-400/50 shadow-2xl shadow-amber-500/25 scale-105 rotate-1"
                      : "border-gray-700/30 hover:border-gray-600/50"
                  }`}
                >
                  {/* Spotlight Effect */}
                  {isActive && (
                    <div className="absolute -inset-2 bg-gradient-to-r from-amber-500/20 via-purple-500/20 to-cyan-500/20 blur-xl animate-pulse rounded-2xl" />
                  )}

                  <div className="relative z-10">
                    <div className="flex items-center gap-6 mb-6">
                      <div
                        className={`p-4 rounded-full bg-gradient-to-r ${reel.color} ${isActive ? "animate-pulse" : ""}`}
                      >
                        <Icon className="w-8 h-8 text-white" />
                      </div>
                      <div className="flex-1">
                        <h3 className="text-xl font-bold tracking-wider mb-2">{reel.name}</h3>
                        <p
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between text-xs text-gray-400 tracking-widest">
                        <span>PROGRESS</span>
                        <span>{isActive ? "85%" : "45%"}%</span>
                      </div>
                      <div className="w-full bg-gray-800/50 rounded-full h-3 overflow-hidden">
                        <div
                          className={`h-full bg-gradient-to-r ${reel.color} transition-all duration-1000 ${
                            isActive ? "animate-pulse" : ""
                          }`}
                          style={{ width: isActive ? "85%" : "45%" }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="mt-6 flex items-center gap-4 text-sm text-gray-400">
                      ...
                      <span className="tracking-wider">ESTIMATED COMPLETION: {isActive ? "2 DAYS" : "1 WEEK"}</span>
                    </div>
                  </div>
          ...
          {/* Studio Status */}
          <div className="bg-gradient-to-r from-gray-900/80 via-black/90 to-gray-900/80 backdrop-blur-sm border border-amber-500/30 rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-center justify-center gap-4 mb-8">
              <Camera className="w-8 h-8 text-amber-400 animate-pulse" />
              <span className="text-2xl font-bold tracking-widest text-amber-400">STUDIO STATUS</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="space-y-2">
                ...
                <div className="text-sm tracking-widest text-gray-400">PRODUCTION</div>
                <div className="w-full h-1 bg-gradient-to-r from-amber-400 to-orange-400 rounded animate-pulse" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded animate-pulse delay-300" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full h-1 bg-gradient-to-r from-cyan-400 to-blue-400 rounded animate-pulse delay-500" />
              </div>
            </div>
          </div>
