      ...
      <div className="bg-[#0f0f0f] py-4 sm:py-6 md:py-6">
        <div className="container mx-auto w-full px-4 sm:px-6 text-center">
          ...
          >
            <button
              type="button"
              className="bg-[#efefef]/5 backdrop-blur-sm cursor-pointer rounded-full border border-[#efefef]/50 text-[#efefef] text-[16px] sm:text-[18px] md:text-[20px] font-medium h-[40px] sm:h-[50px] md:h-[55px] w-[180px] sm:w-[200px] md:w-[220px] px-6 hover:bg-[#efefef] hover:text-black transition-all duration-300 tracking-wider hover:shadow-[0_0_20px_rgba(239,239,239,0.3)] uppercase"            >
              ShowReel
            </button>
          </Link>
        </div>
