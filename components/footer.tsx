...
export default function Footer() {
  return (
    <footer className="bg-[#0f0f0f] text-[#efefef] py-8 md:pb-0 px-4 md:px-6">
      <div className="max-w-4xl mx-auto text-center pb-20 space-y-6 md:space-y-8">
        <div className="space-y-0 md:space-y-0">
          ...
          <h2 className="text-sm sm:text-xl md:text-2xl lg:text-3xl text-[#4b70f5]">
            <i>
              &quot;Let&apos;s create something cenamatic and impactful together!&quot;
            </i>
          </h2>
        </div>
        ...
        <div className="flex justify-center items-center space-x-3 sm:space-x-6 md:space-x-8 lg:space-x-10 pb-20">
      ...
      <p className="flex justify-start text-sm">All rights reserved</p>
    </footer>
  );
}
